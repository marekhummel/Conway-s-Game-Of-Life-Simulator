...
namespace GameOfLife.Forms
{
	public partial class SettingsForm : Form
	{
		...
		public GameOfLife.UISettingsFile UISettings
		{
			get { return uisetts; }
			set
			{
		...
		private void btn_Save_Click(object sender, EventArgs e)
		{
			...
			this.UISettings.GridStyle = gridstyle;
			this.UISettings.CellStyle = cellstyle;
			this.UISettings.Distance = distance;
			this.UISettings.BackgroundColor = backgroundcolor;
			this.UISettings.GridColor = gridcolor;
			this.UISettings.LivingColor = livingcolor;
			this.UISettings.HoverColor = hovercolor;
		...
		//Chance settings
		private void cb_gridstyle_SelectedIndexChanged(object sender, EventArgs e)
		{
			gridstyle = (UI.FieldOfLifeUI.GridStyles)System.Enum.Parse(typeof(UI.FieldOfLifeUI.GridStyles), cb_gridstyle.Text);
		}
		...
		{
			distance = (int)nud_distance.Value;
		}
		...
		private void nud_refreshrate_ValueChanged(object sender, EventArgs e)
		{
			refreshrate = (int)nud_refreshrate.Value;
		}

		private void tb_fieldsize_ValueChanged(object sender, EventArgs e)
		{
			fieldsize = tb_fieldsize.Value;
			this.lbl_fieldsizevalue.Text = tb_fieldsize.Value.ToString();

			nud_distance.Maximum = (int)((this.Width / fieldsize) / 2);
		}

		private void cb_torus_CheckedChanged(object sender, EventArgs e)
		{
			torusactive = cb_torus.Checked;
		}
